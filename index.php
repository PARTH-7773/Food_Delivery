...
<body>
    ...
    <header>
        <nav class="navbar flex between wrapper">
            <a href="#" class="logo">Food Delivery</a>
    ...
    <main>
            ...
            <div class="wrapper p-top">
                ...
                <div class="flex text-center mt-4 gap-4">
                    <div class="service-card">
                        ...
                        <h3>Easy To Order</h3>
                        <p>You only need a few step in ordering food.</p>
                    </div>
        ...
        <section>
            <div class="wrapper p-top flex gap-3">
                <div class="image-container">
                    <img src="images/delivery-boy-with-phone.png">
                </div>
                    ...
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper mt-4">
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="para">
                                    Fresh ingredient,creative menu ,and warm service
                                    make this spot a hidden gem.Perfect for casual dinners
                                    or special nights out.Truly a foodie's paradies!
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="para">
                                    Dilicious dishies.cozy ambiance,and exceptional service.
                                    A must-visit for lovers seeking bold flavors and
        ...
        <section>
            <div class="wrapper p-top ">
                <div class="app-container flex between">
                    <div class="image-container">
                    ...
                    <div class="content">
                        ...
                        <p class="para">
                            Discover food wherever and wherever <br>
        ...
        <section>
            <div class="wrapper p-top">
                <div class="text-center">
                    ...
                    <p class="para">
                        We recommend you to subscribe our newspaper,drop your email <br> below to get deily update about
                        us.
                    </p>
        ...
        <div class="footer-container">
            <div class="flex wrapper gap-4">
                <div class="footer-wrapper">
                    ...
                    <p class="mt-one-half">
                        We will fill tummy with delicuous <br>
                ...
                <ul class="footer-wrapper">
                    ...
                    <li class="mt-one-half">
                        <a href="#" class="footer-link">Categoty</a>
                    </li>
                </ul>
                ...
                <ul class="footer-wrapper">
                    ...
                    <li class="mt-one-half">
                        <a href="#" class="footer-link">Why foodei</a>
                    </li>
                    <li class="mt-one-half">
